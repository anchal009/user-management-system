...
import com.helseapps.task.rest.dto.UserListDTO;
...
public class UserRestController {
    ...
    @GetMapping
    public ResponseEntity<UserListDTO> getUserPresentationList(@Param("keyword") String keyword) {
        List<UserDTO> list = userService.getUserPresentationList(keyword);
